  ...
  <div class="col-md-2">    
    ...
    <div class="card">
      ...
      <div class="card-content table-responsive">
          ...
          <div class="form-group">
            <label for="inputEmail1" class="col-md-2">Fecha de Nacimiento</label>
            <div class="col-md-10">
          ...
          <div class="form-group">
            <label for="inputEmail1" class="col-md-2 ">Tipo de Cobertura</label>
            <div class="col-md-10">
              <label class="checkbox-inline">
          ...
          <div class="form-group">
            <label for="inputEmail1" class="col-md-2">N° Carnet/Socio:</label>
            <div class="col-md-10">
              <textarea name="sick" class="form-control" id="sick" placeholder="Numero de Carnet/Socio"><?php echo $user->sick;?></textarea>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-12">
